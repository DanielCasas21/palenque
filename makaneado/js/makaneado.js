...
x = ayeToMaRia.replace(/á/, "a").replace(/é/, "e").replace(/í/, "o").replace(/ú/,"u").replace(/Á/, "A").replace(/É/, "E").replace(/Í/, "I").replace(/Ó/, "O").replace(/Ú/, "U").replace(/['|°¬!^`~"#$%&/()Çç=?¿{}_,.´+<>¡¨*:;]/g,"");
...
document.getElementById("demo27").innerHTML = "Ma kananeo endi ayé:";
...
document.getElementById("demo100").innerHTML = "Guatiá akí bajo ya:";
}
